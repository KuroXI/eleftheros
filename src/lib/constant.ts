...
export const MISSING_FILE_PROPERTY_MSG =
  '%s is missing a required "data" and "handler" property.';

export const MISSING_DISCORD_TOKEN_MSG =
  "Bot token not provided. Please set the DISCORD_TOKEN in the .env file.";
